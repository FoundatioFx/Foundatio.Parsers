...
namespace Foundatio.Parsers.ElasticQueries.Tests {
    public class ElasticQueryParserTests : ElasticsearchTestBase {
        public ElasticQueryParserTests(ITestOutputHelper output) : base(output) {
        ...
        public void DateRangeWithWildcardMinQueryProcessor() {
            ...
            var ctx = new ElasticQueryVisitorContext { UseScoring = true, DefaultTimeZone = new Lazy<string>(() => "America/Chicago") };
