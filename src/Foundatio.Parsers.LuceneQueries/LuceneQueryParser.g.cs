...
#line default
{
    ...
    public class FieldInfo {
        ...
        public GroupNode Parse(string subject, string fileName, out IList<LexicalElement> lexicalElements)
        {
            ...
            return this.StartRuleHelper(cursor, this.start, "start", out lexicalElements).Value;
        }
                ...
                if (r3 != null)
                {
                    ...
                    if (r4 != null)
                    {
                        ...
                        if (r5 != null)
                        {
                            ...
                            r6 = this.ReturnHelper<IList<string>>(startCursor2, ref cursor, state => l1.AsReadOnly());
                            var boostEnd = cursor;
                    ...
                    if (r35 != null)
                    {
                        ...
                        if (r36 != null)
                        {
                            r0 = this.ReturnHelper<IQueryNode>(startCursor16, ref cursor, state =>
                                #line 102 "LuceneQueryParser.peg"
     {
                    ...
                    if (r39 != null)
                    {
                        ...
                        if (r41 != null)
                        {
                            r0 = this.ReturnHelper<IQueryNode>(startCursor18, ref cursor, state =>
                                #line 109 "LuceneQueryParser.peg"
     {
        ...
        private IParseResult<
            #line 125 "LuceneQueryParser.peg"
          FieldInfo
            #line default
                        ...
                        if (r6 != null)
                        {
                            ...
                            if (r7 != null)
                            {
                                r0 = this.ReturnHelper<FieldInfo>(startCursor0, ref cursor, state =>
                                    #line 127 "LuceneQueryParser.peg"
       {
        ...
        private IParseResult<
            #line 135 "LuceneQueryParser.peg"
     TermNode
            #line default
                                ...
                                if (r8 != null)
                                {
                                    ...
                                    if (r10 != null)
                                    {
                                        r0 = this.ReturnHelper<TermNode>(startCursor0, ref cursor, state =>
                                            #line 137 "LuceneQueryParser.peg"
       {
                                ...
                                if (r19 != null)
                                {
                                    ...
                                    if (r21 != null)
                                    {
                                        r0 = this.ReturnHelper<TermNode>(startCursor6, ref cursor, state =>
                                            #line 153 "LuceneQueryParser.peg"
     {
        ...
        private IParseResult<string> name_term(ref Cursor cursor)
        {
            ...
            if (r1 != null)
            {
                r0 = this.ReturnHelper<string>(startCursor0, ref cursor, state =>
                    #line 172 "LuceneQueryParser.peg"
        term
                    #line default
                    );
            }
        ...
        private IParseResult<string> unquoted_term(ref Cursor cursor)
        {
            ...
            {
                r0 = this.ReturnHelper<string>(startCursor0, ref cursor, state =>
                    #line 178 "LuceneQueryParser.peg"
        term
                    #line default
                    );
            }
        ...
        private IParseResult<string> range_unquoted_term(ref Cursor cursor)
        {
            ...
            {
                r0 = this.ReturnHelper<string>(startCursor0, ref cursor, state =>
                    #line 184 "LuceneQueryParser.peg"
        term
                    #line default
                    );
            }
        ...
        private IParseResult<string> quoted_term(ref Cursor cursor)
        {
            ...
            if (r1 != null)
            {
                ...
                if (r2 != null)
                {
                    ...
                    {
                        r0 = this.ReturnHelper<string>(startCursor0, ref cursor, state =>
                            #line 190 "LuceneQueryParser.peg"
        term
                            #line default
                            );
                    }
        ...
        private IParseResult<
            #line 193 "LuceneQueryParser.peg"
               string
            #line default
            > boost_modifier(ref Cursor cursor)
        {
            ...
            if (r1 != null)
            {
                ...
                if (r2 == null)
                {
                    r2 = this.quoted_term(ref cursor);
                }
                if (r2 == null)
                {
                ...
                {
                    r0 = this.ReturnHelper<string>(startCursor0, ref cursor, state =>
                        #line 196 "LuceneQueryParser.peg"
        boost
                        #line default
                        );
                }
        ...
        private IParseResult<
            #line 199 "LuceneQueryParser.peg"
                   string
            #line default
            > proximity_modifier(ref Cursor cursor)
        {
            ...
            if (r1 != null)
            {
                ...
                {
                    r0 = this.ReturnHelper<string>(startCursor0, ref cursor, state =>
                        #line 202 "LuceneQueryParser.peg"
        proximity
                        #line default
                        );
                }
        ...
        private IParseResult<
            #line 205 "LuceneQueryParser.peg"
                   TermRangeNode
            #line default
                                    ...
                                    if (r7 != null)
                                    {
                                        ...
                                        if (r9 != null)
                                        {
                                            r0 = this.ReturnHelper<TermRangeNode>(startCursor0, ref cursor, state =>
                                                #line 208 "LuceneQueryParser.peg"
        new TermRangeNode {
            Min = term_min,
            Max = term_max,
            MinInclusive = true,
                                    ...
                                    if (r16 != null)
                                    {
                                        ...
                                        if (r18 != null)
                                        {
                                            r0 = this.ReturnHelper<TermRangeNode>(startCursor3, ref cursor, state =>
                                                #line 218 "LuceneQueryParser.peg"
        new TermRangeNode {
            Min = term_min,
            Max = term_max,
            MinInclusive = false,
                                    ...
                                    if (r25 != null)
                                    {
                                        ...
                                        if (r27 != null)
                                        {
                                            r0 = this.ReturnHelper<TermRangeNode>(startCursor6, ref cursor, state =>
                                                #line 228 "LuceneQueryParser.peg"
        new TermRangeNode {
            Min = term_min,
            Max = term_max,
            MinInclusive = false,
                                    ...
                                    if (r34 != null)
                                    {
                                        ...
                                        if (r36 != null)
                                        {
                                            r0 = this.ReturnHelper<TermRangeNode>(startCursor9, ref cursor, state =>
                                                #line 238 "LuceneQueryParser.peg"
        new TermRangeNode {
            Min = term_min,
            Max = term_max,
            MinInclusive = true,
                    ...
                    if (r38 != null)
                    {
                        ...
                        if (r40 != null)
                        {
                            r0 = this.ReturnHelper<TermRangeNode>(startCursor12, ref cursor, state =>
                                #line 248 "LuceneQueryParser.peg"
        new TermRangeNode {
            Min = term_min,
            MinInclusive = true,
            Operator = ">="
                    ...
                    if (r42 != null)
                    {
                        ...
                        if (r44 != null)
                        {
                            r0 = this.ReturnHelper<TermRangeNode>(startCursor14, ref cursor, state =>
                                #line 256 "LuceneQueryParser.peg"
        new TermRangeNode {
            Min = term_min,
            MinInclusive = false,
            Operator = ">"
                    ...
                    if (r46 != null)
                    {
                        ...
                        if (r48 != null)
                        {
                            r0 = this.ReturnHelper<TermRangeNode>(startCursor16, ref cursor, state =>
                                #line 264 "LuceneQueryParser.peg"
        new TermRangeNode {
            Max = term_max,
            MaxInclusive = true,
            Operator = "<="
                    ...
                    if (r50 != null)
                    {
                        ...
                        if (r52 != null)
                        {
                            r0 = this.ReturnHelper<TermRangeNode>(startCursor18, ref cursor, state =>
                                #line 272 "LuceneQueryParser.peg"
        new TermRangeNode {
            Max = term_max,
            MaxInclusive = false,
            Operator = "<"
        ...
        private IParseResult<
            #line 286 "LuceneQueryParser.peg"
             GroupOperator
            #line default
                    ...
                    if (r3 != null)
                    {
                        ...
                        if (r4 != null)
                        {
                            r0 = this.ReturnHelper<GroupOperator>(startCursor0, ref cursor, state =>
                                #line 289 "LuceneQueryParser.peg"
        op
                                #line default
                                );
                        }
                    ...
                    if (r8 != null)
                    {
                        ...
                        if (r9 != null)
                        {
                            r0 = this.ReturnHelper<GroupOperator>(startCursor3, ref cursor, state =>
                                #line 293 "LuceneQueryParser.peg"
        op
                                #line default
                                );
                        }
            ...
            > @operator(ref Cursor cursor)
        {
           ...
           GroupOperator.Or
            ...
            if (r0 == null)
            {
                ...
                {
                    r0 = this.ReturnHelper<GroupOperator>(startCursor3, ref cursor, state =>
                        #line 300 "LuceneQueryParser.peg"
           GroupOperator.And
                        #line default
                        , ruleName: "operator");
                }
        ...
        private IParseResult<string> prefix_operator_exp(ref Cursor cursor)
        {
            ...
            if (r1 != null)
            {
                ...
                {
                    r0 = this.ReturnHelper<string>(startCursor0, ref cursor, state =>
                        #line 305 "LuceneQueryParser.peg"
        op
                        #line default
                        );
                }
